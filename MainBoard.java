    ...
    try
    {
         ...
         else
         {
        	ResultSet rs = stmt.executeQuery("SELECT * FROM stuinfo");
         	while(rs.next()){
         		if(rs.getString("id").equals(userText.getText())){
         			single_Customer = new Professor(rs.getString("id"),rs.getString("password"),rs.getString("name"),rs.getInt("coupon"));
         		}
         	}
            outsider_board();
          }
     ...
     try
     {
      ...
      else
      {
          ...
          outsider_board();
            ...
            SuperviseCustomerPanel temp4=new SuperviseCustomerPanel();
